...
* A computer with the latest version of [Terraform](https://www.terraform.io/downloads) installed. Should you have to manage multiple Terraform versions on a single machine in parallel, the tool [tfswitch](https://tfswitch.warrensbox.com/) might come in handy.
