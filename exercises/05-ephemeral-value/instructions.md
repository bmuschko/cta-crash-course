...
2. Define the AWS provider using the [hashicorp/aws](https://registry.terraform.io/providers/hashicorp/aws/latest) provider with version 6.28.0. Configure the region to `us-west-2`.
3. Define the [random](https://registry.terraform.io/providers/hashicorp/random/latest) provider with version 3.8.0. This provider includes ephemeral resources for generating sensitive values.
